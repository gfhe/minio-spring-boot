...
public class MinioTemplate {
     ...
     * @param mediaType
     */
    public ObjectWriteResponse saveKnownSizeObject(String bucketName, String objectName, InputStream stream, long objectSize, MediaType mediaType) throws IOException, InvalidResponseException, InvalidKeyException, NoSuchAlgorithmException, ServerException, ErrorResponseException, XmlParserException, InvalidBucketNameException, InsufficientDataException, InternalException {
        return saveObject(bucketName, objectName, stream, objectSize, -1, mediaType);
    }
     ...
     * @param stream
     */
    public ObjectWriteResponse saveKnownSizeObject(String bucketName, String objectName, InputStream stream, long objectSize) throws IOException, InvalidResponseException, InvalidKeyException, NoSuchAlgorithmException, ServerException, ErrorResponseException, XmlParserException, InvalidBucketNameException, InsufficientDataException, InternalException {
        MediaType mediaType = MediaTypeFactory.getMediaType(objectName).orElseThrow();
        return saveKnownSizeObject(bucketName, objectName, stream, objectSize, mediaType);
    }
     ...
     * @param mediaType
     */
    public ObjectWriteResponse saveUnknownSizeObject(String bucketName, String objectName, InputStream stream, long partSize, MediaType mediaType) throws IOException, InvalidResponseException, InvalidKeyException, NoSuchAlgorithmException, ServerException, ErrorResponseException, XmlParserException, InvalidBucketNameException, InsufficientDataException, InternalException {
        return saveObject(bucketName, objectName, stream, -1, partSize, mediaType);
    }

    public ObjectWriteResponse saveUnknownSizeObject(String bucketName, String objectName, InputStream stream, long partSize) throws IOException, InvalidResponseException, InvalidKeyException, NoSuchAlgorithmException, ServerException, ErrorResponseException, XmlParserException, InvalidBucketNameException, InsufficientDataException, InternalException {
        MediaType mediaType = MediaTypeFactory.getMediaType(objectName).orElseThrow();
        return saveObject(bucketName, objectName, stream, -1, partSize, mediaType);
    }
     ...
     */
    public ObjectWriteResponse saveObject(String bucketName, String objectName, InputStream stream, long objectSize, long partSize, MediaType mediaType) throws IOException, InvalidKeyException, InvalidResponseException, InsufficientDataException, NoSuchAlgorithmException, ServerException, InternalException, XmlParserException, InvalidBucketNameException, ErrorResponseException {
        PutObjectArgs putObjectArgs = PutObjectArgs.builder()
                .bucket(bucketName)
                .object(objectName)
     ...
     */
    @Deprecated(since = "1.0")
    public void saveObjectExtra(String bucketName, String objectName, InputStream stream, long objectSize, long partSize, Map<String, String> headers, MediaType mediaType, Map<String, String> userMetadata) throws IOException, InvalidKeyException, InvalidResponseException, InsufficientDataException, NoSuchAlgorithmException, ServerException, InternalException, XmlParserException, InvalidBucketNameException, ErrorResponseException {
        PutObjectArgs putObjectArgs = PutObjectArgs.builder()
                .bucket(bucketName)
                .object(objectName)
                .stream(stream, objectSize, partSize)
     ...
     */
    public void saveObjectExtraWithSSE(String bucketName, String objectName, InputStream stream, long objectSize, long partSize, Map<String, String> headers, MediaType mediaType, Map<String, String> userMetadata, ServerSideEncryption serverSideEncryption) throws IOException, InvalidKeyException, InvalidResponseException, InsufficientDataException, NoSuchAlgorithmException, ServerException, InternalException, XmlParserException, InvalidBucketNameException, ErrorResponseException {
        PutObjectArgs putObjectArgs = PutObjectArgs.builder()
                .bucket(bucketName)
                .object(objectName)
                .stream(stream, objectSize, partSize)
